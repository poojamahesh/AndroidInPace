...
public class OptInActivity extends Activity {
    ...
    public void onEnableClicked(View view) {
        ...
        //String gcmSenderId = "899271350779"; // <--- SET THIS STRING TO YOUR PUSH SENDER ID HERE (Google API project #) ##
        //String gcmSenderId = "69231847393";
        String gcmSenderId = "1054070514014";// Google Developers Console Project Number for professor's Gimbal account 
